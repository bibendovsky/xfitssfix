...
#ifndef XFITSSFIX_AL_SYMBOLS_INCLUDED
#define XFITSSFIX_AL_SYMBOLS_INCLUDED

#include <xfitssfix/al.h>
#include <xfitssfix/alc.h>
#include <xfitssfix/efx.h>

using LPEAXSETBUFFERMODE = ALboolean (AL_APIENTRY *)(ALsizei n, ALuint* buffers, ALint value);
using LPEAXGETBUFFERMODE = ALenum (AL_APIENTRY *)(ALuint buffer, ALint* value);

using LPEAXSET = ALenum (AL_APIENTRY *)(const void* psid, ALuint pid, ALuint sid, ALvoid* data, ALuint size);
using LPEAXGET = ALenum (AL_APIENTRY *)(const void* psid, ALuint pid, ALuint sid, ALvoid* data, ALuint size);

namespace xfitssfix {

struct AlSymbolsNames
{
...
#endif // !XFITSSFIX_AL_SYMBOLS_INCLUDED
